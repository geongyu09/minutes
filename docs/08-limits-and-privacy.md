...
> ⚠️ **노션 액세스 토큰이 서버 DB에 평문으로 저장됩니다.** 이 프로젝트의 설계 문서는 AES-256-GCM 암호화를 요구하고 있지만 아직 구현되지 않았습니다. 서버 DB 파일에 접근할 수 있는 사람은 연결된 모든 워크스페이스의 노션 토큰을 볼 수 있습니다. 운영자는 [서버 운영](07-server-admin.md)의 보안 항목을 반드시 확인하세요.
